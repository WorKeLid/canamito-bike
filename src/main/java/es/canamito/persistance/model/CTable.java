...
public class CTable implements Serializable {
	...
	@Id
	@SequenceGenerator(name = "c_table_c_table_id_seq", sequenceName = "c_table_c_table_id_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "c_table_c_table_id_seq")
