...
public class CMenu implements Serializable, Comparable<CMenu> {
	...
	@Id
	@SequenceGenerator(name = "c_menu_c_menu_id_seq", sequenceName = "c_menu_c_menu_id_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "c_menu_c_menu_id_seq")
