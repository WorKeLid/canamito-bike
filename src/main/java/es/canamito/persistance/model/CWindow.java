...
public class CWindow implements Serializable {
	...
	@Id
	@SequenceGenerator(name = "c_window_c_window_id_seq", sequenceName = "c_window_c_window_id_seq", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "c_window_c_window_id_seq")
